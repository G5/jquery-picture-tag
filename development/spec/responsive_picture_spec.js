...
(function() {
  ...
  describe("RP", function() {
    it("defines RP namespace", function() {
      return expect(RP).toBeDefined;
    });
    return it("defines responsivePicture method on jQuery objects", function() {
      return expect($.prototype.responsivePicture).toBeDefined;
    });
  });

  describe("RP.Picture", function() {
    var $el;
    $el = $('\
    <picture>\
  ...
  ');
    beforeEach(function() {
      return this.picture = new RP.Picture($el);
    });
  ...
  ');
    beforeEach(function() {
      return this.img = new RP.Img($el.children("img:first"));
    });
  ...
  ');
    beforeEach(function() {
      return this.sources = new RP.Sources($el.children("source"));
    });
    describe("attribute", function() {
    ...
    return describe("method", function() {
      ...
      return describe("_newSource", function() {
        return it("returns a RP.Source", function() {
          return expect(this.sources._newSource()).toEqual(jasmine.any(RP.Source));
        });
      });
    });
  });

  describe("RP.Source", function() {
    var $el;
    $el = $('\
    <picture>\
      <source media="(min-width: 980px)" srcset="images/large-1.jpg 1x">\
  ...
  ');
    beforeEach(function() {
      return this.media = new RP.Media($el.children("source:first").attr("media"));
    });
    return describe("method", function() {
      describe("isBetterThan", function() {
